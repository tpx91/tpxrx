...
function getStateDomainFilePath(projectNs, domainNs, fileSuffix) {
    return (0, devkit_1.joinPathFragments)(globals_1.__libDirName, projectNs.name, 'src', 'lib', '+state', domainNs.fileName, `${domainNs.fileName}.${fileSuffix}`);
}
exports.getStateDomainFilePath = getStateDomainFilePath;
function getStateProjectFilePath(projectNs, fileSuffix) {
    return (0, devkit_1.joinPathFragments)(globals_1.__libDirName, projectNs.name, 'src', 'lib', '+state', `${projectNs.fileName}.${fileSuffix}`);
}
exports.getStateProjectFilePath = getStateProjectFilePath;
function getModuleFilePath(projectNs, fileSuffix) {
    return (0, devkit_1.joinPathFragments)(globals_1.__libDirName, projectNs.name, 'src', 'lib', `${projectNs.fileName}.${fileSuffix}`);
}
exports.getModuleFilePath = getModuleFilePath;
function getLibIndexPath(projectNs) {
    return (0, devkit_1.joinPathFragments)(globals_1.__libDirName, projectNs.name, 'src', 'index.ts');
}
exports.getLibIndexPath = getLibIndexPath;
function getLibPath(projectNs) {
    return (0, devkit_1.joinPathFragments)(globals_1.__libDirName, projectNs.name, 'src', 'lib');
}
exports.getLibPath = getLibPath;
function getStatePath(projectNs) {
    return (0, devkit_1.joinPathFragments)(globals_1.__libDirName, projectNs.name, 'src', 'lib', '+state');
}
exports.getStatePath = getStatePath;
function getStateDomainPath(projectNs, domainNs) {
    return (0, devkit_1.joinPathFragments)(globals_1.__libDirName, projectNs.name, 'src', 'lib', '+state', domainNs.fileName);
}
exports.getStateDomainPath = getStateDomainPath;
function getLibFilePath(projectNs, filename) {
    return (0, devkit_1.joinPathFragments)(globals_1.__libDirName, projectNs.name, 'src', 'lib', filename);
}
exports.getLibFilePath = getLibFilePath;
function getModuleTemplatePath() {
    return (0, devkit_1.joinPathFragments)(__dirname, '..', 'templates', 'file-templates', 'module-files');
}
exports.getModuleTemplatePath = getModuleTemplatePath;
function getProjectTemplatePath() {
    return (0, devkit_1.joinPathFragments)(__dirname, '..', 'templates', 'file-templates', 'project-files');
}
exports.getProjectTemplatePath = getProjectTemplatePath;
function getDomainTemplatePath() {
    return (0, devkit_1.joinPathFragments)(__dirname, '..', 'templates', 'file-templates', 'domain-files');
}
